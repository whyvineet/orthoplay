      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-12 text-center hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="mb-8">
              <p className="text-2xl font-bold text-gray-900 mb-2 transition-colors duration-300 hover:text-gray-800">
                The word was:{' '}
                <span className="text-blue-600 transition-colors duration-300 hover:text-blue-700">{correctWord.toUpperCase()}</span>
              </p>
              ...
              >
                <Volume2 className="h-5 w-5 mr-2 transition-transform duration-300 group-hover:scale-110" />
